...
- `flash`
  ...
  `-c "program build/cross/riscv/debug/CH32V208GBU_Templete.elf verify"`
  `-c "reset run"`
  `-c "exit"`
- `clean`
...
- Main app entry: `app/main.c`
- Primary firmware output: `build/cross/riscv/debug/CH32V208GBU_Templete.elf`
