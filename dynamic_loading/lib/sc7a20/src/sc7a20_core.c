...
static int sc7a20_core_read_reg_impl(sc7a20_dev_t *dev,
                                     uint8_t reg,
                                     uint8_t *data,
                                     uint16_t len,
                                     uint8_t auto_inc)
...
{
    return sc7a20_core_read_reg_impl(dev, reg, data, len, 1u);
}

int sc7a20_core_read_reg_noinc(sc7a20_dev_t *dev, uint8_t reg, uint8_t *data, uint16_t len)
{
    return sc7a20_core_read_reg_impl(dev, reg, data, len, 0u);
}
