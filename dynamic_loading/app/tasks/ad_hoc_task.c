...
#ifndef ADHOC_TASK_ROLE_GATEWAY
#define ADHOC_TASK_ROLE_GATEWAY 0u
#endif

#ifndef ADHOC_TASK_NODE_MEM_CAP
#define ADHOC_TASK_NODE_MEM_CAP 5120u
#endif
...
static tmosEvents ad_hoc_task_process_event(tmosTaskID task_id, tmosEvents events)
{
    ...
    if (events & AD_HOC_EVT_INIT)
    {
        ...
        role_gateway = (uint8_t)(ADHOC_TASK_ROLE_GATEWAY != 0u);
        gateway_no = (uint8_t)(ADHOC_TASK_GATEWAY_NO & 0x07u);
